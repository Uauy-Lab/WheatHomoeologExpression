...
mean(kaks_low10$average, na.rm=TRUE) ##0.211635
sd(kaks_low10$average, na.rm=TRUE) ##0.3651612
sd(kaks_low10$average, na.rm=TRUE)/sqrt(length(kaks_low10$average[!is.na(kaks_low10$average)])) ##0.009434715

mean(kaks_top10$average, na.rm=TRUE) ##0.3261166
sd(kaks_top10$average, na.rm=TRUE) ##0.3980446
sd(kaks_top10$average, na.rm=TRUE)/sqrt(length(kaks_top10$average[!is.na(kaks_top10$average)])) ##0.0102672

mean(kaks_mid80$average, na.rm=TRUE) ##0.2631622
sd(kaks_mid80$average, na.rm=TRUE) ##0.333147
sd(kaks_mid80$average, na.rm=TRUE)/sqrt(length(kaks_mid80$average[!is.na(kaks_mid80$average)])) ##0.003040189
...
##
##
## Also do for 5-90-5 subsets of genes

setwd("Y:/expression_browser/dataset_reports/20170911_all_reports/02.movement/HC_Development/")
top_5_genes <- read.csv("HC_Development_movement_top_5pc.txt")
low_5_genes <- read.csv("HC_Development_movement_low_5pc.txt")
mid_90_genes <- read.csv("HC_Development_movement_middle_90pc.txt")
...
setwd("Y:/expression_browser/dataset_reports/20170911_all_reports/02.movement/HC_Development/")
top_25_genes <- read.csv("HC_Development_movement_top_25pc.txt")
low_25_genes <- read.csv("HC_Development_movement_low_25pc.txt")
mid_50_genes <- read.csv("HC_Development_movement_middle_50pc.txt")
...
##get average and se of kaks for the different sets
mean(kaks_low25$average, na.rm=TRUE) ##0.2185327
sd(kaks_low25$average, na.rm=TRUE) #0.3208998
sd(kaks_low25$average, na.rm=TRUE)/sqrt(length(kaks_low25$average[!is.na(kaks_low25$average)])) ##0.00524097

mean(kaks_top25$average, na.rm=TRUE) ##0.3094085
sd(kaks_top25$average, na.rm=TRUE) ##0.3769413
sd(kaks_top25$average, na.rm=TRUE)/sqrt(length(kaks_top25$average[!is.na(kaks_top25$average)])) ##0.006152145

mean(kaks_mid50$average, na.rm=TRUE) ##0.2646464
sd(kaks_mid50$average, na.rm=TRUE) ##0.3356324
sd(kaks_mid50$average, na.rm=TRUE)/sqrt(length(kaks_mid50$average[!is.na(kaks_mid50$average)])) ##0.003873999
