...
setwd("Y:\\expression_browser\\WGA\\WGCNA\\abiotic_vs_disease\\abiotic\\maxP0.05\\")
...
# read meta-data
metadata_file <- "Y:\\expression_browser\\WGA\\WGCNA\\abiotic_vs_disease\\abiotic\\WGCNA_metadata_cluster_intermediate_stress.csv"
...
metadata_intermed_stress$cold <-  metadata_intermed_stress$Intermediate == "cold 2 weeks (4C)"
metadata_intermed_stress$PEG_6000 <-  metadata_intermed_stress$Intermediate == "PEG 6000"
metadata_intermed_stress$drought <-  metadata_intermed_stress$Intermediate == "drought stress"
metadata_intermed_stress$drought_heat <-  metadata_intermed_stress$Intermediate == "drought&heat combined stress"
metadata_intermed_stress$heat <-  metadata_intermed_stress$Intermediate == "heat stress"
metadata_intermed_stress$phosphorous <-  metadata_intermed_stress$Intermediate == "Phosphorous starvation 10 d shoots"
metadata_intermed_stress$cold_control <-  metadata_intermed_stress$Intermediate == "cold 2 weeks control"
metadata_intermed_stress$PEG_6000_control <-  metadata_intermed_stress$Intermediate == "PEG 6000 control"
metadata_intermed_stress$drought_heat_control <-  metadata_intermed_stress$Intermediate == "heat drought control"
metadata_intermed_stress$phosphorous_control <-  metadata_intermed_stress$Intermediate == "Phosphorous starvation shoots control"
...
setwd("Y:\\expression_browser\\WGA\\WGCNA\\abiotic_vs_disease\\abiotic\\maxP0.05\\trait_module_correlations")
