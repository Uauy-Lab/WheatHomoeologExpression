...
studies_toKeep <- c("PAMP Triggered Imune Response","ERP013983", "SRP041017","SRP078208",
                    "ERP009837","SRP048912")
metadata <-  metadata[metadata$study_title%in%studies_toKeep,]
metadata <- metadata[metadata[,"High.level.tissue"] == "leaves/shoots",]
samples_toFilter <- c("ERR789114","ERR789113","ERR789116","ERR789099" )
metadata <-  metadata[! metadata$Sample.IDs%in%samples_toFilter,]
...
print(dim(counts))
setwd("/nbi/Research-Groups/NBI/Cristobal-Uauy/expression_browser/WGA/WGCNA/abiotic_vs_disease/disease")
