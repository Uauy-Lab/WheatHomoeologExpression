# aim is to run WGCNA on root samples from RNA-seq
# 31-08-2016
# Philippa Borrill
...
# setup R correctly
# if in cluster
setwd("/nbi/Research-Groups/NBI/Cristobal-Uauy/expression_browser/WGA/WGCNA/tissues/root/")
...
setwd("/nbi/Research-Groups/NBI/Cristobal-Uauy/expression_browser/WGA/WGCNA/tissues/root/maxP0.05")


# This shows that for a signed hybrid network I should use a power of 7. 
power <- 7
