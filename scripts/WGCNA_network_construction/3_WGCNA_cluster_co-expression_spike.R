# aim is to run WGCNA on spike samples from RNA-seq
# 31-08-2016
# Philippa Borrill
...
# setup R correctly
# if in cluster
setwd("/nbi/Research-Groups/NBI/Cristobal-Uauy/expression_browser/WGA/WGCNA/tissues/spike/")
...
setwd("/nbi/Research-Groups/NBI/Cristobal-Uauy/expression_browser/WGA/WGCNA/tissues/spike/maxP0.05")
